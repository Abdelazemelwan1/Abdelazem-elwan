...
// const cardGLB = '/models/Untitled@1-1360x599 (1).png';
// const cardGLB = '/models/starter_scene_copy.gltf';

import lanyard from '../../assets/Yellow Black Cream Dinner Menu (4).png';
